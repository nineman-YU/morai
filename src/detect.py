...
class Yolov5Detector:
    def __init__(self):
        ...
        self.person_pub = rospy.Publisher("/person_detect", Int32MultiArray, queue_size=10)
    ...
    def callback(self, data):
        ...
        if len(det):
            ...
            for *xyxy, conf, cls in reversed(det):
                ...
                box_size = [int((xyxy[2]-xyxy[0])*(xyxy[3]-xyxy[1]))]
                centers.extend(box_size)
        ...
        self.person_pub.publish(centers_msg)
