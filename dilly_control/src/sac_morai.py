...
def load_models(episode_count):
    ...
    value_net.load_state_dict(torch.load(dirPath + '/SAC_Models/' + world + '/' +  str(ensemble) + '/'+ str(episode_count)+ '_value_net.pth'))
    soft_q_net.load_state_dict(torch.load(dirPath + '/SAC_Models/' + world + '/' +  str(ensemble) + '/'+ str(episode_count)+ '_soft_q_net.pth'))
    target_value_net.load_state_dict(torch.load(dirPath + '/SAC_Models/' + world + '/'+  str(ensemble) + '/' + str(episode_count)+ '_target_value_net.pth'))
    print('***Models load***')
